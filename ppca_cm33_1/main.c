...
* File Name:   main.c
*
* Description: This is the main file for the PPCA CPU core 1.
* As this core is not used in this code example, it does nothing.
*
...
*********************************************************************************
* Summary:
* This is the main function for PPCA CPU 1. As this core is not used in the code
